...
namespace MvcClient.Controllers
{
    ...
    public class CustomerController : BaseController
    {
        ...
        public async System.Threading.Tasks.Task<JsonResult> Update(Customer obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.CustomerId.ToString(), ApiHttpMethod.PUT, BearerToken);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async System.Threading.Tasks.Task<JsonResult> Delete(Customer obj)
        {
            try
            {
                obj = await apiClient.PostObject(obj, url + "/" + obj.CustomerId.ToString(), ApiHttpMethod.DELETE, BearerToken);
            }
            catch (Exception ex)
            {
                throw ex;
